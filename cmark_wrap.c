...
static swig_lua_const_info swig_SwigModule_constants[]= {
    {SWIG_LUA_CONSTTAB_STRING("VERSION", "0.1")},
    {SWIG_LUA_CONSTTAB_INT("NONE", CMARK_NODE_NONE)},
    {SWIG_LUA_CONSTTAB_INT("DOCUMENT", CMARK_NODE_DOCUMENT)},
    {SWIG_LUA_CONSTTAB_INT("BLOCK_QUOTE", CMARK_NODE_BLOCK_QUOTE)},
    {SWIG_LUA_CONSTTAB_INT("LIST", CMARK_NODE_LIST)},
    {SWIG_LUA_CONSTTAB_INT("LIST_ITEM", CMARK_NODE_LIST_ITEM)},
    {SWIG_LUA_CONSTTAB_INT("CODE_BLOCK", CMARK_NODE_CODE_BLOCK)},
    {SWIG_LUA_CONSTTAB_INT("HTML", CMARK_NODE_HTML)},
    {SWIG_LUA_CONSTTAB_INT("PARAGRAPH", CMARK_NODE_PARAGRAPH)},
    {SWIG_LUA_CONSTTAB_INT("HEADER", CMARK_NODE_HEADER)},
    {SWIG_LUA_CONSTTAB_INT("HRULE", CMARK_NODE_HRULE)},
    {SWIG_LUA_CONSTTAB_INT("REFERENCE_DEF", CMARK_NODE_REFERENCE_DEF)},
    {SWIG_LUA_CONSTTAB_INT("FIRST_BLOCK", CMARK_NODE_FIRST_BLOCK)},
    {SWIG_LUA_CONSTTAB_INT("LAST_BLOCK", CMARK_NODE_LAST_BLOCK)},
    {SWIG_LUA_CONSTTAB_INT("TEXT", CMARK_NODE_TEXT)},
    {SWIG_LUA_CONSTTAB_INT("SOFTBREAK", CMARK_NODE_SOFTBREAK)},
    {SWIG_LUA_CONSTTAB_INT("LINEBREAK", CMARK_NODE_LINEBREAK)},
    {SWIG_LUA_CONSTTAB_INT("INLINE_CODE", CMARK_NODE_INLINE_CODE)},
    {SWIG_LUA_CONSTTAB_INT("INLINE_HTML", CMARK_NODE_INLINE_HTML)},
    {SWIG_LUA_CONSTTAB_INT("EMPH", CMARK_NODE_EMPH)},
    {SWIG_LUA_CONSTTAB_INT("STRONG", CMARK_NODE_STRONG)},
    {SWIG_LUA_CONSTTAB_INT("LINK", CMARK_NODE_LINK)},
    {SWIG_LUA_CONSTTAB_INT("IMAGE", CMARK_NODE_IMAGE)},
    {SWIG_LUA_CONSTTAB_INT("FIRST_INLINE", CMARK_NODE_FIRST_INLINE)},
    {SWIG_LUA_CONSTTAB_INT("LAST_INLINE", CMARK_NODE_LAST_INLINE)},
...
const char* SWIG_LUACODE=
  ...
  "            local stype\n"
  "            if ltype == cmark.CMARK_BULLET_LIST then\n"
  "               stype = 'bullet'\n"
  "            elseif ltype == cmark.CMARK_ORDERED_LIST then\n"
  "               stype = 'ordered'\n"
  "            end\n"
